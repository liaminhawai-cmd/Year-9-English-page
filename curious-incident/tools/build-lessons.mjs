...
const lessons = [
  {
    ...
    develop: [H("Task 1 · Table talk"),
              ...
              B("Level 11. Last two lines."),
              H("Task 2 · Model Table 1"),
              B("One group, 90 seconds, at level 5 then at level 9.")],
    apply: [B(["Display mode on the ", { link: L.prompts(1) }, ": six rotations, 4 min talk, 2 min write, move up one table."]),
  ...
  },
  {
    ...
    develop: [H("Task 1 · Table talk"),
              ...
              H("Task 2 · The Reader"),
              B("Reads the statement, asks both sides, picks who speaks, checks who moved. Changes every table."),
              B("Be Reader at Table 1 for one group, 90 seconds.")],
    apply: [B(["Display mode on the ", { link: L.prompts(2) }, ": six rotations, 4 min talk, 2 min write, move up one table. New Reader each table."]),
            B(["Teacher at Table 1: level and evidence on the front page. Listen for the quote-back and the concession. ", { link: L.tTable1 }]),
            B("Finished early: write the statement your table would argue about more.")],
  ...
  },
  {
    ...
    apply: [B(["Display mode on the ", { link: L.prompts(3) }, ": six rotations, 4 min talk, 2 min write, move up one table. Someone reads, three questions, one thing agreed."]),
